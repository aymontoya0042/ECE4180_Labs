...
void
uLCD_4DGL::set_byte_address(int hi, int lo)
{
  char command[5] = "";
  command[0]      = SBADDRESS;
...
void
uLCD_4DGL::set_sector_address(int hi, int lo)
{
...
void
uLCD_4DGL::write_byte(int value)
{
  char command[3] = "";
...
void
uLCD_4DGL::write_word(int value)
{
  char command[3] = "";
...
void
uLCD_4DGL::display_image(int x, int y)
{
  char command[6] = "";
...
void
uLCD_4DGL::display_video(int x, int y)
{
  char command[5] = "";
...
void
uLCD_4DGL::display_frame(int x, int y, int w)
{
  char command[7] = "";
