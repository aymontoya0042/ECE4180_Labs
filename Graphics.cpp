...
void
uLCD_4DGL::circle(int x, int y, int radius, int color) // draw a circle in (x,y)
{
  char command[9] = "";
...
void
uLCD_4DGL::filled_circle(
  int x,
  int y,
  int radius,
  int color) // draw a circle in (x,y)
{
  char command[9] = "";
...
void
uLCD_4DGL::line(int x1, int y1, int x2, int y2, int color) // draw a line
{
  char command[11] = "";
...
void
uLCD_4DGL::rectangle(int x1, int y1, int x2, int y2, int color) // draw a
                                                                // rectangle
{
  char command[11] = "";
...
void
uLCD_4DGL::filled_rectangle(
  int x1,
  int y1,
  int x2,
  int y2,
  int color) // draw a rectangle
{
  char command[11] = "";
...
void
uLCD_4DGL::pixel(int x, int y, int color) // draw a pixel
{
  char command[7] = "";
...
void
uLCD_4DGL::BLIT(int x, int y, int w, int h, int* colors) // draw a block of
                                                         // pixels
{
...
int
uLCD_4DGL::read_pixel(int x, int y) // read screen info and populate data
{
...
void
uLCD_4DGL::pen_size(char mode) // set pen to SOLID or WIREFRAME
{
  char command[2] = "";
