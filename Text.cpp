...
void
uLCD_4DGL::set_font(char mode) // set font - system or SD media
{
  char command[3] = "";
...
void
uLCD_4DGL::text_mode(char mode) // set text mode
{
  char command[3] = "";
...
void
uLCD_4DGL::text_bold(char mode) // set text mode
{
  char command[3] = "";
...
void
uLCD_4DGL::text_italic(char mode) // set text mode
{
  char command[3] = "";
...
void
uLCD_4DGL::text_inverse(char mode) // set text mode
{
  char command[3] = "";
...
void
uLCD_4DGL::text_underline(char mode) // set text mode
{
  char command[3] = "";
...
void
uLCD_4DGL::text_width(char width) // set text width
{
  char command[3] = "";
...
void
uLCD_4DGL::text_height(char height) // set text height
{
  char command[3] = "";
...
void
uLCD_4DGL::text_char(char c, char col, char row, int color) // draw a text char
{
  char command[6] = "";
...
void
uLCD_4DGL::locate(char col, char row) // place text curssor at col, row
{
  char command[5] = "";
  current_col     = col;
  current_row     = row;
...
void
uLCD_4DGL::color(int color) // set text color
{
  char command[5] = "";
  current_color   = color;
  command[0]      = 0x7F; // set color
...
void
uLCD_4DGL::putc(char c) // place char at current cursor position
...
void
uLCD_4DGL::puts(char* s) // place string at current cursor position
{
